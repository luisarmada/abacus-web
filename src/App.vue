  ...
  <div id="app">
    <nav class="navbar">
      <div class="navbar-logo">
        <img src="/images/dragon_red_logo.png" alt="Logo" />
      </div>
...
<script>
import ParallaxLanding from './components/ParallaxLanding.vue';
...
.navbar a:visited {
  color: white; /* Match normal link color */
}
